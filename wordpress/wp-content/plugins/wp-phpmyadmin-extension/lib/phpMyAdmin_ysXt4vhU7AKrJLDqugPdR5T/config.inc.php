...
$cfg['blowfish_secret']					= '5(a]Su,asiL6B.F~;9X({XA:nCWgF:!r' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_ysXt4vhU7AKrJLDqugPdR5T/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'http://localhost:8080/wp-admin/?rand=99367638&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'http://localhost:8080/wp-admin/?rand=67810146&pma_logout=1';
